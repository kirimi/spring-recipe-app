...
public class IndexControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        controller = new IndexController(categoryRepository, unitOfMeasureRepository, recipeListService);
    }
    ...
    public void getIndexPage() {
        ...
        when(recipeListService.getReceipeList()).thenReturn(recipes);
        ...
        verify(recipeListService, times(1)).getReceipeList();
